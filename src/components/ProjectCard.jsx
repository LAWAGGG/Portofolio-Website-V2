            ...
            <div className="pt-4 flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                    <a href={project.github} target="_blank" rel="noreferrer"
                        className="text-dim hover:text-fg transition-colors p-1.5" aria-label={`${project.title} on GitHub`}>
                        <Github size={15} />
                    </a>
                    {project.demo && (
                        <a href={project.demo} target="_blank" rel="noreferrer"
                            className="text-dim hover:text-fg transition-colors p-1.5" aria-label={`${project.title} live demo`}>
